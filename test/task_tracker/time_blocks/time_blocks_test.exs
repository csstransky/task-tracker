defmodule TaskTracker.TimeBlocksTest do
  ...
  describe "time_blocks" do
    ...
    @valid_attrs %{time_end: ~N[2010-04-17 14:00:00.000000], time_start: ~N[2010-04-17 14:00:00.000000]}
    @update_attrs %{time_end: ~N[2011-05-18 15:01:01.000000], time_start: ~N[2011-05-18 15:01:01.000000]}
    ...
    test "create_time_block/1 with valid data creates a time_block" do
      ...
      assert time_block.time_start == ~N[2010-04-17 14:00:00.000000]
    end
    ...
    test "update_time_block/2 with valid data updates the time_block" do
      ...
      assert time_block.time_start == ~N[2011-05-18 15:01:01.000000]
    end
